...
function managePost() {
    ...
    this.changeToFavs = () => {
        postManage.innerHTML = overallFavorites;
        highlightOpts[0].style.backgroundColor = "#eee";
        highlightOpts[1].style.backgroundColor = "#d6d6d7";
    }

    // Highlights and grabs array of own posts and adds to feed
    this.changeToOwnPosts = () => {
        postManage.innerHTML = overallPosts;
        highlightOpts[0].style.backgroundColor = "#d6d6d7";
        highlightOpts[1].style.backgroundColor = "#eee";
    }
