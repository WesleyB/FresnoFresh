...
function temp() {
    let currentUser = JSON.parse(localStorage.getItem('userDataBase'))[localStorage.getItem('currentUser')];
    ...
    this.renewUser = () => {
        currentUser = JSON.parse(localStorage.getItem('userDataBase'))[localStorage.getItem('currentUser')];
